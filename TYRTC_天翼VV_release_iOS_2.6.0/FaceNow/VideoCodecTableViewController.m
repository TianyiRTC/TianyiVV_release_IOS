...
//        self.videoResolutionSelected = [NSIndexPath indexPathForRow:3 inSection:1];
//    }
...
//        self.videoResolutionSelected = [NSIndexPath indexPathForRow:5 inSection:1];
//    }else if ([reso isEqualToString:@"D4(1280*720"]) {
//        self.videoResolutionSelected = [NSIndexPath indexPathForRow:6 inSection:1];
//    }
...
//    [self.videoResolutionListData setObject:@"QVGA(320*240)" forKey:@"2.QVGA"];
    [self.videoResolutionListData setObject:@"标清" forKey:@"3.CIF"];
//    [self.videoResolutionListData setObject:@"VGA(640*480)" forKey:@"4.VGA"];
    [self.videoResolutionListData setObject:@"高清" forKey:@"5.4CIF"];
//    [self.videoResolutionListData setObject:@"D1(720*576)" forKey:@"6.D1"];
//    [self.videoResolutionListData setObject:@"D4(1280*720" forKey:@"7.D4"];
